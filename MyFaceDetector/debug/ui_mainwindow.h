...
**
** Created: Sun Jun 16 19:17:11 2013
...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        lineEditTh = new QLineEdit(tabInput);
        lineEditTh->setObjectName(QString::fromUtf8("lineEditTh"));

        gridLayout->addWidget(lineEditTh, 1, 0, 1, 1);
        ...
        listViewLoadedImages->setEditTriggers(QAbstractItemView::EditKeyPressed);

        gridLayout->addWidget(listViewLoadedImages, 3, 0, 1, 2);

        pushButtonClearLoadedImages = new QPushButton(tabInput);
        pushButtonClearLoadedImages->setObjectName(QString::fromUtf8("pushButtonClearLoadedImages"));

        gridLayout->addWidget(pushButtonClearLoadedImages, 0, 1, 1, 1);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        lineEditTh->setText(QApplication::translate("MainWindow", "0.7", 0, QApplication::UnicodeUTF8));
        pushButtonSelectImage->setText(QApplication::translate("MainWindow", "Browse...", 0, QApplication::UnicodeUTF8));
        pushButtonClearLoadedImages->setText(QApplication::translate("MainWindow", "Clear", 0, QApplication::UnicodeUTF8));
