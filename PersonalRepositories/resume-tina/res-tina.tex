...
\newcommand{\CVSection}[1]{
  \noindent\hspace{-10em}\colorbox{lightgray}{%
...
\Description{\MarginText{Address}Cumhuriyet Mah.,Ye\c{s}ilay Sok.,9/1,Hac{\i}osman,Istanbul} % Personal 

\Description{\MarginText{Cell Phone}+90 (506) 120 6201} % Phone number(s)
...
\CVSection{Work Experience}\vspace{1em}

%------------------------------------------------

\NewEntry{2011--2013}{Researcher, \textsc{ADAX Project}  --- Istanbul}

\Description{\MarginText{Bogazici University}Worked as a member of research team in ADAX (Attacks Detection And Countermeasures Simulation) which aims to study feasibility of solutions enabling to detect complex attacks against an information system. \\ Reference: Prof. Emin \textsc{Anarim}\ \ $\cdotp$\ \ \href{anarim@boun.edu.tr}{anarim@boun.edu.tr}}

%------------------------------------------------

\NewEntry{2008-2009}{Sales Manager, \textsc{F.R.S. Co.} --- Tehran,Iran}
...
\NewEntry{2014-\small Present}{Bogazici University, Istanbul}
...
\Description{{\bf Tina Seifpoor}, Ramin Fadaei Fouladi, Derya Erhan, Emin Anarim, “Statistical filtering against DoS/DdoS attack”, Masfor 2012 Bogazici University, Istanbul, Turkey.}
\Description{Ramin Fadaei Fouladi, {\bf Tina Seifpoor}, Derya Erhan, Emin Anarim, “Frequency Domain Analysis Approach in Detecting Shrew DDoS Attacks”, Masfor 2012 Bogazici University, Istanbul, Turkey.}
\Description{Ramin Fadaei Fouladi, {\bf Tina Seifpoor}, Emin Anarim, “Frequency Characteristics of DoS and DDoS Attacks”, SIU 2013, Northern Cyprus.}
...
\Description{\MarginText{Working Permit}2015\ \ $\cdotp$\ \ Extendable to 2019}
